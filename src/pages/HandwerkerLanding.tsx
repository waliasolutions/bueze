        ...
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center mb-12">
              <Button size="lg" onClick={() => navigate('/handwerker-onboarding')} className="gap-2">
      ...
      <section className="py-20 bg-gradient-to-b from-pastel-blue-50 to-brand-600">
        <div className="container mx-auto px-4">
          <div className="max-w-3xl mx-auto text-center">
            ...
            <Button size="lg" onClick={() => navigate('/handwerker-onboarding')} className="gap-2 bg-white text-brand-600 hover:bg-white/90">
              Jetzt kostenlos registrieren
              <ArrowRight className="h-5 w-5" />
            </Button>
          </div>
