-- Update can_submit_proposal to use 30-day rolling periods from registration
-- Still uses Swiss timezone for DST safety
...
BEGIN
  ...
  IF sub_record.current_period_end < NOW() THEN
    -- Calculate new 30-day period from now (Swiss time)
